...
namespace Enterprise.Core.Internal
{
    public class MessageSender : IMessageSender
    {
        ...
        {
            if (s_diagnosticListener.IsEnabled(DiagnosticListenerNames.BeforePublish))
            {
                ...
                s_diagnosticListener.Write(DiagnosticListenerNames.BeforePublish, eventData);
        ...
        {
            if (tracingTimestamp != null && s_diagnosticListener.IsEnabled(DiagnosticListenerNames.AfterPublish))
            {
                ...
                s_diagnosticListener.Write(DiagnosticListenerNames.AfterPublish, eventData);
            }
        }

        private void TracingError(long? tracingTimestamp, TransportMessage message, BrokerAddress broker, OperateResult result)
        {
            if (tracingTimestamp != null && s_diagnosticListener.IsEnabled(DiagnosticListenerNames.ErrorPublish))
            {
                ...
                s_diagnosticListener.Write(DiagnosticListenerNames.ErrorPublish, eventData);
            }
        }
